...
if CLIENT then
	...
	SWEP.Icon = "VGUI/ttt/icon_dt_axe"
...
function SWEP:PrimaryAttack()
   ...
   if IsValid(hitEnt) or tr_main.HitWorld then
      self.Weapon:SendWeaponAnim( ACT_VM_HITCENTER )
				...
				if (sound_hit == 1) then
					self.Weapon:EmitSound( "weapons/melee/crowbar/crowbar_hit-1.wav" )
				else
					self.Weapon:EmitSound( "weapons/melee/crowbar/crowbar_hit-3.wav" )
				end
				--
