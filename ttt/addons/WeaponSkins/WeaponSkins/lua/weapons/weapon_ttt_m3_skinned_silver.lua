...
if CLIENT then
   SWEP.PrintName 					= BASE.PrintName .. " | Silver"
   SWEP.Slot 						= BASE.Slot
   SWEP.Icon 						= BASE.Icon
...
SWEP.Base							= BASE.Base
SWEP.Spawnable 						= true
SWEP.Skin 							= "drunkent/tttweaponskins/v_models/skin_m3_silver"
SWEP.World 							= "drunkent/tttweaponskins/w_models/w_skin_m3_silver"
