...
if CLIENT then
	...
	SWEP.Icon = "VGUI/ttt/icon_dt_sledge"
...
function SWEP:PrimaryAttack()
   ...
   if IsValid(hitEnt) or tr_main.HitWorld then
      self.Weapon:SendWeaponAnim( ACT_VM_HITCENTER )
				...
				if (sound_hit == 1) then
					self.Weapon:EmitSound( "weapons/melee/golf club/golf_hit-01.wav" )
				elseif (sound_hit == 2) then
					self.Weapon:EmitSound( "weapons/melee/golf club/golf_hit-02.wav" )
				elseif (sound_hit == 3) then
					self.Weapon:EmitSound( "weapons/melee/golf club/golf_hit-03.wav" )
				else
					self.Weapon:EmitSound( "weapons/melee/golf club/golf_hit-04.wav" )
				end
				--
