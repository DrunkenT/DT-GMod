...
if CLIENT then
	...
	SWEP.PrintName = "Wood Plank"
	
	SWEP.Slot = 0
	
	SWEP.Icon = "VGUI/ttt/icon_dt_plank"
...
function SWEP:PrimaryAttack()
   ...
   if IsValid(hitEnt) or tr_main.HitWorld then
      self.Weapon:SendWeaponAnim( ACT_VM_HITCENTER )
				...
				if (sound_hit == 1) then
					self.Weapon:EmitSound( "physics/wood/wood_box_impact_hard1.wav" )
				elseif (sound_hit == 2) then
					self.Weapon:EmitSound( "physics/wood/wood_box_impact_hard2.wav" )
				elseif (sound_hit == 3) then
					self.Weapon:EmitSound( "physics/wood/wood_box_impact_hard3.wav" )
				else
					self.Weapon:EmitSound( "physics/wood/wood_box_impact_hard4.wav" )
				end
				--
