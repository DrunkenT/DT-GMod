...
if CLIENT then
	...
	SWEP.Icon = "VGUI/ttt/icon_dt_diamondsword"
...
function SWEP:PrimaryAttack()
   ...
   if IsValid(hitEnt) or tr_main.HitWorld then
      self.Weapon:SendWeaponAnim( ACT_VM_HITCENTER )
				...
				if (sound_hit == 1) then
					self.Weapon:EmitSound( "diamondsword/ground_hit_4.wav" )
				else
					self.Weapon:EmitSound( "diamondsword/ground_hit_5.wav") 
				end
				--
...
function SWEP:GetClass()
	return "weapon_ttt_diamondsword"
end
